...
summary: Guide to using and configuring input devices on AerynOS
---
...
```bash
sudo moss install xorg-driver-input-synaptics
```
...
sudo moss remove xorg-driver-input-synaptics
```
