...
summary: Guide for installing and configuring MIDI keyboards on AerynOS
---

# MIDI Keyboards

These instructions will guide you through how to set up and use a USB-connected MIDI keyboard on AerynOS. This will easily let you use the keyboard to play music with a wide set of instruments.
...
```bash
sudo moss install qsynth qjackctl fluid-soundfont
```
