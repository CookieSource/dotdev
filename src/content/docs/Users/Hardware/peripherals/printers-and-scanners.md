...
summary: Guide to using printers and scanners on AerynOS
---
...
Many printers will work out-of the box on AerynOS. If yours doesn't, you should try installing additional drivers.
...
The AerynOS repositories include `brlaser`, an open-source driver for many Brother monochrome laser printers and multi-function devices. Compatible models are listed [here](https://github.com/Owl-Maintain/brlaser#supported-printers)
...
This list should not suggest that _only_ such devices listed below are compatible with AerynOS, as there may be devices not listed below that are in fact compatible.
...
Should your printer not be on this list, and the generic `brlaser` driver does not work, you can request your printer here for inclusion [here](https://github.com/AerynOS/recipes/issues)
