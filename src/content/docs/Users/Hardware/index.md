---
title: Hardware
summary: Guide to using additional hardware on AerynOS
---
...
The purpose of this documentation is to help you find drivers for hardware that is not directly supported or requires additional configuration to be used on AerynOS.
...
Installing proprietary drivers may improve performance or certain features, however they are usually not necessary for normal daily usage. AerynOS provides a utility for installing drivers for detected hardware.
