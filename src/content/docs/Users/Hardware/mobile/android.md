---
title: Android
summary: Quick guide to working with Android devices on AerynOS
---

# Android

For the most part, Android devices will work out of the box on AerynOS. The experience is similar to other operating systems.
...
```bash
sudo moss install android-tools
```
