...
Filesystem performance depends on your workload. For AerynOS, the root filesystem impacts how quickly
moss can create and activate new system states. XFS tends to perform best for this workflow, while
ext4 remains a safe default for compatibility and stability. CoW filesystems such as Btrfs and ZFS
provide snapshots and compression but can add overhead that affects small-file workloads. Always test
with your actual workloads before switching filesystems.
