...
import BootAndChroot from "./boot-rescue/snippets/_mount_partitions.mdx";
...
1. Boot from a live USB, which you can create from one of the [AerynOS installers](https://getsol.us/download/).
...
1. Change to your user's directory in the chrooted environment:
