...
- [A AerynOS Live USB](../../quick-start/installation/#creating-bootable-media)
...
1. Boot from a AerynOS live USB.
1.  Mount the partitions of your AerynOS system.
...
1. Repair your AerynOS installation.
    <details>
...
1. Unmount all the AerynOS partitions.
