---
title: How to chroot into your AerynOS
description: Chroot into an AerynOS installation from a live environment.
published: true
...
1. Start your computer from a live Linux USB or DVD. This will allow you to access and modify the AerynOS installation.
...
This will create a new directory called "aerynos" in the "/mnt" directory.
```
mkdir /mnt/aerynos
```
4. Find the partition AerynOS is installed on
...
```
mount /dev/sdaX /mnt/aerynos
```
5. Chroot into AerynOS
Type the following command
```
chroot /mnt/aerynos /bin/bash
```
Now if everything went well you're in your AerynOS installation. From here you can troubleshoot issues or revert breaking changes.
