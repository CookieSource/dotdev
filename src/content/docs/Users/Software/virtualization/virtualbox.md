---
title: VirtualBox
summary: Quick start guide for VirtualBox on AerynOS
---
...
AerynOS support both a `current` and `lts` kernel. It is important to install the version that corresponds to your kernel.
...
VirtualBox Guest Additions are available in the Software Center, select the package that matches kernel version on the AerynOS virtual machine.
...
- VirtualBox was manually installed and it conflicts with the version installed from the AerynOS Repository.
