---
title: XRDP
summary: User guide for XRDP on AerynOS
---
...
AerynOS has an xrdp integration package for each Desktop Environment that will install the correct configuration for that DE. Install the respective package for your DE.
