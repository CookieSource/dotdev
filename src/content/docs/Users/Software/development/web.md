...
summary: Install and configure different web development tools on AerynOS.
---
...
AerynOS provides multiple web servers for local testing of web applications.

:::caution Important

**AerynOS is not a server operating system**. Usage of server packages outside local testing is not recommended.
...
1. Install `php` from the Software Center or execute the following command: `sudo moss install php`.
