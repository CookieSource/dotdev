---
title: Java
summary: Learn how to install, run, and manage Java on AerynOS.
---

# Java

AerynOS includes multiple LTS versions of Java in the repositories. You can install more than one version in your system at once.
...
All Java packages in the AerynOS repositories include the _Java Runtime Environment_ (JRE) and the _Java Development Kit_ (JDK).

The following table lists the versions of Java available in the AerynOS repositories.
...
AerynOS does not add Java to the `PATH` environment variable by default.

:::

There are multiple ways to execute Java applications in AerynOS:
