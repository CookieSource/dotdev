...
:::warning
Snaps may be [**removed from AerynOS in 2025**][2],
and are not fully confined in AerynOS with Linux kernel 6.9 and newer.
...
The `snap` command provided by AerynOS shows a warning when strict confinement is not available.
For example:
...
[2]: https://github.com/AerynOS/recipes/issues
[3]: https://github.com/AerynOS/recipes/issues
